...
//GET PAGE INFO=========================
	$page_title=$myFn->getPageInfo($conn,'title','setup_install',$lang);
	$page_keyword=$myFn->getPageInfo($conn,'keyword','setup_install',$lang);
	$page_desc=$myFn->getPageInfo($conn,'description','setup_install',$lang);

//GET SHOT WORD==========================
	$txt_setup=$myFn->getWord($conn,'setup_install',$lang);
?>
...
<div class="header header_thin" style="background-image:url(images/contents/setup_install.jpg)">
	<div class="header_title">
    	<h1 class="yssfont01"><i class="fa fa-gears"></i> <span><?php echo $txt_setup ?></span></h1>
    </div>
</div>
...
<div class="middle_row row_white breadcrumbs">
    <div class="container">
        <p><a href="index.php">Home</a>  <span class="separator">&rsaquo;</span><span class="current">Setup & Install</span></p>
    </div>
</div>
<!--/ breadcrumbs -->
...
//GET CONTENT BY LANGUAGE================
	if($lang=='TH'){
		$sql="SELECT *  FROM yss_content WHERE lang='TH' AND page='10' ORDER BY sort_order ASC";
	}
	if($lang=='EN'){
		$sql="SELECT *  FROM yss_content WHERE lang='EN' AND page='10' ORDER BY sort_order ASC";
	}else{
		$sql="SELECT *  FROM yss_content WHERE lang='TH' AND page='10' ORDER BY sort_order ASC";
	}
