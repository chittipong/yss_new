...
//GET PAGE INFO=========================
	$page_title=$myFn->getPageInfo($conn,'title','brand',$lang);
	$page_keyword=$myFn->getPageInfo($conn,'keyword','brand',$lang);
	$page_desc=$myFn->getPageInfo($conn,'description','brand',$lang);
...
<div class="header header_thin" style="background-image:url(images/rnd/B189.jpg)">
	<div class="header_title">
    	<h1 class="yssfont01"><span>BRAND</span></h1>
    </div>
</div>
<!--/Head-->
