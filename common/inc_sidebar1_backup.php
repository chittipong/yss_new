	        ...
	        <div class="widget-container widget_adv_filter">
                ...
                <form action="product-list.php" method="GET" class="side_form">
                    ...
                    <div class="row field_select" style="z-index:10">
                        ...
                        <select class="select_styled2 white_select" name="brand" id="search-brand">
                    ...
                    <div class="row field_select" style="z-index:9">
                        ...
                        <select class="select_styled2 white_select" name="model" id="search-model">
                        	<option value="" class="default">- All -</option>
	                         <?php 
                    ...
                    <div class="row field_select" style="z-index:8">
	                    ...
	                    <select class="select_styled2 white_select" name="year" id="search-year">
                        	<option value="" class="default">- All -</option>
