...
conndb();
	...
	$FILE = fopen( "fabric_suit3.csv", "r");// ใส่ชื่อไฟล์ และ โหมด r เพื่ออ่านข้อมูลจากไฟล์อย่างเดียว 
...
$sql="INSERT INTO `tb_fabric` (`fabric_code`, `brand`, `type`, `color`, `design`, `description`,`file`) VALUES ('$fabricCode', '$brand', '$type', '$color','$design','$desc', '$file')";
