...
/*$sql="SELECT * FROM application_list WHERE vehicle_type='5'";
...
while($data=mysqli_fetch_assoc($rs)){
		...
		$sqlArray[]="INSERT INTO `yss_product` (
			...
			`emulsion`, `piggy_back`, `on_hose`, `free_piston`, `dtg`, `vin_no`, `series`, `outer_tube`, `enable`
		) VALUES (
			'$id', '$brand', '', '', '','$vehicle_type', '$product_code', '$type', '$top', '$bottom', '$pic', '$spring', '$length', '$piston', '$shaft', '$preload', '$rebound', '$compression', '$length_adjust', '$hydraulic', '$emulsion', '$piggy_back', '$on_hose', '$free_piston', '$dtg', '$vin_no', '$series', '$outer_tube', 'Y')";
