...
conndb();
	...
	$FILE = fopen( "fabric_shirt.csv", "r");// ใส่ชื่อไฟล์ และ โหมด r เพื่ออ่านข้อมูลจากไฟล์อย่างเดียว 
...
$sql="INSERT INTO `tb_fabric` (`fabric_code`, `brand`, `type`, `color`,`file`) VALUES ('$fabricCode', '$brand', '$type', '$color', '$file')";
