...
conndb();
	...
	$FILE = fopen( "shirt_contrast.csv", "r");// ใส่ชื่อไฟล์ และ โหมด r เพื่ออ่านข้อมูลจากไฟล์อย่างเดียว 
...
$sql="INSERT INTO `contrast_fabric` (`contrast_code`, `title`, `type`, `file`) VALUES ('$code', '$title', '$type','$file')";
