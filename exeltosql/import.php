...
$FILE = fopen( "mydata.csv", "r");// ใส่ชื่อไฟล์ และ โหมด r เพื่ออ่านข้อมูลจากไฟล์อย่างเดียว 
...
$product_id = $data[0]; // ข้อมูลฟิลด์แรก ซ้ายสุด
$product_name = $data[1]; // ข้อมูลฟิลด์ที่สอง จากซ้าย
