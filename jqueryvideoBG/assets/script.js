...
$(document).ready(function() {
	...
	$('#yssBG-Video').videoBG({
		mp4:'jqueryvideoBG/assets/14YSSAuto2014.mp4',
		ogv:'jqueryvideoBG/assets/14YSSAuto2014.ogv',
		webm:'jqueryvideoBG/assets/14YSSAuto2014.webm',
		poster:'jqueryvideoBG/assets/yss_video1.jpg',
		scale:true,
		zIndex:0
	});
