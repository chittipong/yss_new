...
//CHECK LANGUAGE=========================
isset($_SESSION['sess_lang']) ?$_SESSION['sess_lang']:'TH';
...
//GET PAGE INFO=========================
	$page_title=$myFn->getPageInfo($conn,'title','warranty',$lang);
	$page_keyword=$myFn->getPageInfo($conn,'keyword','warranty',$lang);
	$page_desc=$myFn->getPageInfo($conn,'description','warranty',$lang);
...
//GET CONTENT BY LANGUAGE================
	if($lang=='TH'){
		$sql="SELECT *  FROM yss_content WHERE lang='TH' AND page='11' ORDER BY sort_order ASC";
	}
	if($lang=='EN'){
		$sql="SELECT *  FROM yss_content WHERE lang='EN' AND page='11' ORDER BY sort_order ASC";
	}else{
		$sql="SELECT *  FROM yss_content WHERE lang='TH' AND page='11' ORDER BY sort_order ASC";
	}
