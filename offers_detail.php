...
<title>AutoTrader - Offer Details</title>
			...
			<nav id="topmenu" class="clearfix">            
				<ul class="dropdown">    
                	<li class="menu-level-0"><a href="#"><span>Home</span></a>
						<ul class="submenu-1">
	                    	<li class="menu-level-1"><a href="index1.html"><span>Home Slider 1</span></a></li>
					...
					<li class="menu-level-0 current-menu-ancestor"><a href="#"><span>Our Cars</span></a>
                    	<ul class="submenu-1">
                            ...
                            <li class="menu-level-1 current-menu-item"><a href="offers-list.html"><span>Offers List - Filter Right</span></a></li>
...
<div class="header header_thin" style="background-image:url(images/temp/slider_1_1.jpg)">
	...
	<div class="header_title">
    	<h1><span>Mercedes-Benz</span> ML 320 CDI 4Matic</h1>
    </div>
...
<div class="middle_row row_white breadcrumbs">
    <div class="container">
        <p><a href="index1.html">Home</a>  <span class="separator">&rsaquo;</span>  <a href="offers-list.html">SUVs & Pick-Ups</a> <span class="separator">&rsaquo;</span>  <a href="offers-list.html">Mercedes-Benz</a>  <span class="separator">&rsaquo;</span>  <span class="current">M-Klasse</span></p>
        <a href="offers-list.html" class="link_back">Back to Previous Page</a>
    </div>
</div>
<!--/ breadcrumbs -->
            ...
            <div class="offer_details clearfix">
            	...
            	<div class="offer_gallery">
                	<div class="gallery_images">
                    	<div id="gallery_images">
                            ...
                            <span>Exterior view - 20” rims and inteligent headlights <em class="ico_large"></em></span></a>
                            </div>
                            <div class="gallery_image_item">
                            <img src="images/temp/prod_gallery_2.jpg" alt="">
                            <a href="images/temp/prod_gallery_2.jpg" data-rel="prettyPhoto[gal]">
                            <span>7G-Tronic Plus seven-speed automatic transmission <em class="ico_large"></em></span></a>
                            </div>
                            <div class="gallery_image_item"> 
                            <img src="images/temp/prod_gallery_3.jpg" alt="">
                            <a href="images/temp/prod_gallery_3.jpg" data-rel="prettyPhoto[gal]"></a> <!-- example without caption -->
                            </div>
                            <div class="gallery_image_item">
                            <img src="images/temp/prod_gallery_4.jpg" alt="">
                            <a href="images/temp/prod_gallery_4.jpg" data-rel="prettyPhoto[gal]">
                            <span>Adaptive Cruise Control (Distronic Plus) <em class="ico_large"></em></span></a>
                            </div>
                            <div class="gallery_image_item">
                            <img src="images/temp/prod_gallery_5.jpg" alt="">
                            <a href="images/temp/prod_gallery_5.jpg" data-rel="prettyPhoto[gal]">
                            <span>Lane Departure Warning System and an adjustable-height air suspension <em class="ico_large"></em></span></a>
                            </div>
                            <div class="gallery_image_item">
                            <img src="images/temp/prod_gallery_6.jpg" alt="">
                            <a href="images/temp/prod_gallery_6.jpg" data-rel="prettyPhoto[gal]">
                            <span>3.2-litre V6 engine <em class="ico_large"></em></span></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="offer_aside">
                	<div class="offer_price">
                    	<strong>61,950 EUR</strong><br>
						<em>49,500 EUR (Net)  19% VAT</em>
                        
                        <a href="#" class="btn_save">SAVE VEHICLE</a>
                    </div>
                    ...
                    <div class="offer_specification">
                    	<ul>
                    		<li><span class="spec_name">Motor Capacity:</span> <strong class="spec_value">3598 cm³</strong> (Power 510 BHP / 375 kW)</li>
                            <li><span class="spec_name">Fuel Type:</span> <strong class="spec_value">Diesel</strong> (Unleaded)</li>
                            <li><span class="spec_name">Body Type:</span> <strong class="spec_value">SUV</strong> (5 doors)</li>
                            <li><span class="spec_name">Gearbox Type:</span> <strong class="spec_value">Automatic</strong> (DSG 7 speed)</li>
                            <li><span class="spec_name">CO2 emissions:</span> <strong class="spec_value">EURO 5</strong> (428 g/KM)</li>
                            <li><span class="spec_name">Country of Origin:</span> <strong class="spec_value">Germany</strong> (Frankfurt)</li>
                    	</ul>
                    </div>
