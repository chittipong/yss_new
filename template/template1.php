...
<!-- header -->
<div class="header header_thin" style="background-image:url(images/introduction/b193.jpg)">   
	<div class="header_title">
    	<h1 class="yssfont01">aaaaaaa | <span>bbbbbbbb</span></h1>
    </div>
</div>
<!--/ header -->
...
<div class="middle_row row_white breadcrumbs">
    <div class="container">
        <p><a href="index.php">Home</a><span class="separator">&rsaquo;</span> <span class="current">aaaaaa</span></p>
    </div>
</div>
<!--/ breadcrumbs -->
