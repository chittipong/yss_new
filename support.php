...
//GET PAGE INFO=========================
	$page_title=$myFn->getPageInfo($conn,'title','support',$lang);
	$page_keyword=$myFn->getPageInfo($conn,'keyword','support',$lang);
	$page_desc=$myFn->getPageInfo($conn,'description','support',$lang);

//GET SHOT WORD==========================
	$txt_support=$myFn->getWord($conn,'support',$lang);
?>
...
//GET CONTENT BY LANGUAGE================
	if($lang=='TH'){
		$sql="SELECT *  FROM yss_content WHERE lang='TH' AND page='$page' ORDER BY sort_order ASC";
	}
	if($lang=='EN'){
		$sql="SELECT *  FROM yss_content WHERE lang='EN' AND page='$page' ORDER BY sort_order ASC";
	}else{
		$sql="SELECT *  FROM yss_content WHERE lang='TH' AND page='$page' ORDER BY sort_order ASC";
	}
...
<div class="header header_thin" style="background-image:url(images/contents/banner-002_gray.jpg)">
	<div class="header_title">
    	<h1 class="yssfont01"><i class="fa fa-truck"> </i> <span><?php echo $txt_support ?></span></h1>
    </div>
</div>
...
<div class="middle_row row_white breadcrumbs">
    <div class="container">
        <p><a href="index.php">Home</a>  <span class="separator">&rsaquo;</span><span class="current">Support</span></p>
    </div>
</div>
<!--/ breadcrumbs -->
