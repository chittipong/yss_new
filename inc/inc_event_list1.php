...
<?php
	//GET News===================================
		$sql_slide="SELECT n.id,n.pic,d.title FROM yss_news n,yss_news_detail d WHERE n.id=d.news_id AND type='EVENT' GROUP BY d.news_id ORDER BY n.date_create ASC";
